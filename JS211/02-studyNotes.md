...
- for `==` and comparison operators:  (if number, then numbers)
  ...
  2. arrays to string (`[]` as `''`, `[1, 2, 3]` as `'1,2,3'`, `[null]`, `[undefined]` as `''`, `[false]` as `'false'`)
...
[] == ![]; // 4  :  '' == false  :  true
[null] == ''; // 5  :  '' == ''  :  true
[undefined] == false; // 6  :  '' == false  :  true
[false] == false; // 7  :  'false' == false  :  NaN == 0  :  false
1 + true // 8  :  1 + 1  :  2
'4' + 3 // 9  :  '4' + '3'  :  '43'
false == 0 // 10  :  0 == 0  :  true
+('123') // 11  :  123
...
[] + 5 // 34  :  '' + 5  :  '5'
[] + true // 35  :  '' + 'true'  :  'true'
42 + {} // 36  :  42 + ''  :  '42'  ****** '42[object Object]'
(function foo() {}) + 42 // 37  :  'function foo() {}42'
1 - true // 38  :  1 - 1  :  0
'123' * 3 // 39  :  123 * 3  :  369
'8' - '1' // 40  :  8 - 1  :  7
-'42' // 41  :  -42
